                                            ...
                                            <div class="featured-thumb hover-zoomer mb-4">
                                                <div class="overlay-black overflow-hidden position-relative">
                                                    ...
                                                    <div class="price text-primary">
                                                        <b>MAD<?php echo $row['13']; ?></b>
                                                        <span class="text-white"><?php echo $row['12']; ?> m²</span>
                                                    </div>
                                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div
                                    ...
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
										$query=mysqli_query($con,"SELECT count(state), property * FROM property where city='Casablanca'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                            ...
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div
                                    ...
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
										$query=mysqli_query($con,"SELECT count(state), property * FROM property where city='Rabat'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                        <h4 class="hover-text-success text-capitalize"><a
                            ...
                            <div class="col-md-6 col-lg-3 pb-1">
                                ...
                                <div
                                    ...
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
										$query=mysqli_query($con,"SELECT count(state), property * FROM property where city='Marrakech'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                        <h4 class="hover-text-success text-capitalize"><a
                            ...
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div
                                    ...
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
										$query=mysqli_query($con,"SELECT count(state), property * FROM property where city='Fes'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                        <h4 class="hover-text-success text-capitalize"><a

    ...
    <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-4">
                            <div class="footer-widget mb-4">
                                ...
                                <p class="pb-20 text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab
                                    beatae id quibusdam quaerat voluptatem vel reiciendis recusandae nulla cupiditate
                                    quo doloremque, pariatur alias porro similique reprehenderit obcaecati inventore
                                    molestias quam.
                                    nam.</p>
                                ...
                                <div class="col-md-4 col-lg-4">
                                    <div class="footer-widget">
                                        ...
                                        <ul class="text-white">
                                            ...
                                            <li class="hover-text-primary"> <i
                                                    class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+212546565869
                                            </li>
                                            <li class="hover-text-primary"> <i
                                                    class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+212546565869
                                            </li>
        ...
        <div class="row copyright">
            <div class="col-sm-6"> <span class="text-white">© <?php echo date('Y');?> Real Estate Website - Developed By
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit.!</span> </div>
            <div class="col-sm-6">
